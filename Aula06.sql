...
CREATE DATABASE IF NOT EXISTS ultima_aula;
...
INSERT INTO itens_pedido(id_pedido, id_bebida, quantidade) VALUES
(1, 1, 2),
(1, 2, 1),
(1, 4, 2);
...
INSERT INTO pedidos (cliente, total, data_finalizacao) VALUES ("Francisco", 0, "2023-05-10");
SELECT * FROM pedidos;
